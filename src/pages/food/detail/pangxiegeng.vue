    ...
    <view class="main-content">
      ...
      <view class="recipe-content-vertical">
        <view class="vertical-text">
          【食材】螃蟹两只、嫩豆腐一块、姜一小块、小葱两根、淀粉、盐、白胡椒粉、香油。<br> 【制作步骤】
          螃蟹洗净蒸熟后拆出蟹肉与蟹黄备用；嫩豆腐切成指甲盖大小的方丁，姜切细丝，小葱切末；锅中加清
          水烧开，放入豆腐丁与姜丝煮五分钟；加入蟹肉与蟹黄，调入盐与白胡椒粉，小火续煮三分钟；以水淀粉
          勾薄芡，撒入葱末，滴入香油即可。
        </view>
      </view>
  ...
  data() {
    return {
      dish: {
        id: 1,
        name: '东坡肉',
        image: '/static/pangxiegeng-detail.png', // 请确保路径正确
        liked: false,
      }
    }
  },
