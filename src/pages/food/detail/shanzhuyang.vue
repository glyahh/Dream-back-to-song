    ...
    <view class="main-content">
      ...
      <view class="recipe-content-vertical">
        <view class="vertical-text">
          【食材】羊腩一斤半、白萝卜半根、姜一块、花椒十余粒、盐、黄酒、陈皮一角。<br> 【制作步骤】
          羊腩洗净后切三厘米见方的块，入凉水锅中煮沸撇去浮沫；白萝卜去皮切滚刀块，姜用刀拍松；
          取砂锅放入焯好的羊块，加足量清水并投入姜块、花椒与陈皮，淋入黄酒；大火烧开后转小火
          慢炖一个时辰，放入萝卜块续炖两刻钟，调入盐即可。
        </view>
      </view>
  ...
  data() {
    return {
      dish: {
        id: 1,
        name: '东坡肉',
        image: '/static/shanzhuyang-detail.jpg', // 请确保路径正确
        liked: false,
      }
    }
  },
