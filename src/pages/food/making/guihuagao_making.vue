  ...
  <view class="making-page">
    ...
    <view class="main-content">
      ...
      <view class="step-image-container">
        <image class="step-image" src="/static/food_dessert.jpg" mode="aspectFit" />
      </view>

      <view class="step-description">
        <text class="description-text">将糯米粉和粘米粉混合，调成糊状</text>
      </view>

      <view class="button-container">
        <view class="prev-btn disabled">
          <image class="btn-bg" src="/static/begin.jpg" mode="aspectFill" />
          <text class="btn-text">上一步</text>
        </view>
        <view class="next-btn" @click="goToStep2">
          <image class="btn-bg" src="/static/begin.jpg" mode="aspectFill" />
...
export default {
  ...
  methods: {
    goBack() {
      ...
      uni.navigateBack({
        ...
        fail: () => {
          ...
          uni.redirectTo({
            url: '/pages/food/detail/guihuagao?id=' + this.dishId
          })
        },
        complete: () => {
          setTimeout(() => {
    ...
    goToStep2() {
      uni.navigateTo({
        url: '/pages/food/making/guihuagao_step2?id=' + this.dishId
      })
    }
  }
}
