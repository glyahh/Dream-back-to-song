<template>
  <view class="dessert-page">
    <!-- 顶部导航栏 -->
    <view class="nav-bar">
      <view class="back-btn" @click="goBack">
        <text class="back-icon">‹</text>
      </view>
      <text class="nav-title">点心</text>
...
export default {
  ...
  methods: {
    ...
    goToDishDetail(dish) {
      const detailPages = {
        1: '/pages/food/detail/guihuagao',       // 桂花糕
        2: '/pages/food/detail/lvdougao',        // 绿豆糕
        3: '/pages/food/detail/zaonisu',         // 枣泥酥
        4: '/pages/food/detail/xingrenbing'      // 杏仁饼
      }
