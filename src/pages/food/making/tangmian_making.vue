  ...
  <view class="making-page">
    ...
    <view class="main-content">
      ...
      <view class="step-image-container">
        <image class="step-image" src="/static/food_noodle.jpg" mode="aspectFit" />
      </view>

      <view class="step-description">
        <text class="description-text">锅中烧水，水开后下入细面</text>
      </view>
...
export default {
  ...
  methods: {
    goBack() {
      ...
      uni.navigateBack({
        ...
        fail: () => {
          ...
          uni.redirectTo({
            url: '/pages/food/detail/tangmian?id=' + this.dishId
          })
        },
        complete: () => {
          setTimeout(() => {
    ...
    goToStep2() {
      uni.navigateTo({
        url: '/pages/food/making/tangmian_step2?id=' + this.dishId
      })
    }
  }
}
