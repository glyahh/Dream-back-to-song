<template>
  <view class="vegetarian-page">
    <!-- 顶部导航栏 -->
    <view class="nav-bar">
      <view class="back-btn" @click="goBack">
        <text class="back-icon">‹</text>
      </view>
      <text class="nav-title">素食</text>
...
export default {
  ...
  methods: {
    ...
    goToDishDetail(dish) {
      // 根据菜品ID跳转到对应的详情页
      const detailPages = {
        1: '/pages/food/detail/sucaidoufu',      // 素炒豆腐
        2: '/pages/food/detail/suzhengqiezi',    // 素蒸茄子
        3: '/pages/food/detail/suchaoshishu',    // 素炒时蔬
        4: '/pages/food/detail/sutang'           // 素汤
      }
