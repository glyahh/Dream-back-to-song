    ...
    <view class="main-content">
      ...
      <view class="recipe-content-vertical">
        <view class="vertical-text">
          【食材】嫩鸡半只、春笋两根、干香菇三朵、姜三片、葱一根、盐、黄酒、白胡椒粉。<br> 【制作步骤】
          嫩鸡洗净斩成三厘米见方的块，用盐、黄酒与白胡椒粉抓匀腌渍片刻；春笋剥壳切滚刀块，
          干香菇泡发后切厚片；取深盘将笋块与香菇铺底，码上鸡块并放姜片与葱段；蒸锅水沸后放入，
          以中火蒸三刻钟，拣去葱姜即可。
        </view>
      </view>
  ...
  data() {
    return {
      dish: {
        id: 1,
        name: '东坡肉',
        image: '/static/xiansunzhengji-detail.png', // 请确保路径正确
        liked: false,
      }
    }
  },
