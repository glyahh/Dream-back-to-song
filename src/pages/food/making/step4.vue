  ...
  <view class="making-page">
    ...
    <view class="main-content">
      ...
      <view class="step-indicator">
        <text class="step-text">第四步</text>
      </view>

      <!-- 步骤图片 -->
      <view class="step-image-container">
        <image class="step-image" src="/static/dongporou_step4.png" mode="aspectFit" />
      </view>

      <!-- 步骤描述 -->
      <view class="step-description">
        <text class="description-text">肉皮朝下码加入黄酒、生抽和冰糖</text>
      </view>

      <!-- 底部按钮 -->
      <view class="button-container">
        <!-- 上一步按钮 -->
        <view class="prev-btn" @click="goToStep3">
          <image class="btn-bg" src="/static/begin.jpg" mode="aspectFill" />
          <text class="btn-text">上一步</text>
        </view>

        <!-- 下一步按钮 -->
        <view class="next-btn" @click="goToStep5">
          <image class="btn-bg" src="/static/begin.jpg" mode="aspectFill" />
