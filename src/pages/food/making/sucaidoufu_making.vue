  ...
  <view class="making-page">
    ...
    <view class="main-content">
      ...
      <view class="step-image-container">
        <image class="step-image" src="/static/food_vegetarian.jpg" mode="aspectFit" />
      </view>

      <view class="step-description">
        <text class="description-text">豆腐切块，用淡盐水浸泡去腥</text>
      </view>
...
export default {
  ...
  methods: {
    ...
    goToStep2() {
      uni.navigateTo({
        url: '/pages/food/making/sucaidoufu_step2?id=' + this.dishId
      })
    }
  }
}
