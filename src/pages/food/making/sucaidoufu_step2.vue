  ...
  <view class="making-page">
    ...
    <view class="main-content">
      ...
      <view class="step-description">
        <text class="description-text">热锅下油，放入姜丝爆香</text>
      </view>

      <view class="button-container">
        <view class="prev-btn" @click="goToStep1">
          <image class="btn-bg" src="/static/begin.jpg" mode="aspectFill" />
          <text class="btn-text">上一步</text>
        </view>
        <view class="next-btn" @click="goToStep3">
          <image class="btn-bg" src="/static/begin.jpg" mode="aspectFill" />
...
export default {
  ...
  methods: {
    ...
    goToStep3() {
      uni.navigateTo({
        url: '/pages/food/making/sucaidoufu_step3?id=' + this.dishId
      })
    }
  }
}
