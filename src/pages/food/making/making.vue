  ...
  <view class="making-page">
    ...
    <view class="main-content">
      ...
      <view class="step-image-container">
        <image class="step-image" src="/static/dongporou_step1.png" mode="aspectFit" />
      </view>

      <!-- 步骤描述 -->
      <view class="step-description">
        <text class="description-text">五花肉切成约四厘米左右的方块</text>
      </view>
...
export default {
  ...
  methods: {
    ...
    goToStep2() {
      uni.navigateTo({
        url: '/pages/food/making/step2?id=' + this.dishId
      });
    }
  }
}
