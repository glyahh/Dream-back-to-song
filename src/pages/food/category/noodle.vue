<template>
  <view class="noodle-page">
    <!-- 顶部导航栏 -->
    <view class="nav-bar">
      <view class="back-btn" @click="goBack">
        <text class="back-icon">‹</text>
      </view>
      <text class="nav-title">面食</text>
...
export default {
  ...
  methods: {
    ...
    goToDishDetail(dish) {
      const detailPages = {
        1: '/pages/food/detail/tangmian',        // 汤面
        2: '/pages/food/detail/sumian',          // 素面
        3: '/pages/food/detail/banmian',         // 拌面
        4: '/pages/food/detail/tangbing'         // 汤饼
      }
